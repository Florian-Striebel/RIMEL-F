...
#if !defined(_MATH_CONFIG_H)
#define _MATH_CONFIG_H

#include <math.h>
#include <stdint.h>

#if !defined(WANT_ROUNDING)
...
#define WANT_ERRNO 0
#endif
#if !defined(WANT_ERRNO_UFLOW)

#define WANT_ERRNO_UFLOW (WANT_ROUNDING && WANT_ERRNO)
#endif


#if !defined(HAVE_FAST_ROUND)
#if __aarch64__
...
#endif
#define strong_alias(f, a) extern __typeof (f) a __attribute__ ((alias (#f))) attribute_copy (f);

#define hidden_alias(f, a) extern __typeof (f) a __attribute__ ((alias (#f), visibility ("hidden"))) attribute_copy (f);
