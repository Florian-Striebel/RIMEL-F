...
#define ph_proto(a_attr, a_prefix, a_ph_type, a_type) a_attr void a_prefix##new(a_ph_type *ph); a_attr bool a_prefix##empty(a_ph_type *ph); a_attr a_type *a_prefix##first(a_ph_type *ph); a_attr a_type *a_prefix##any(a_ph_type *ph); a_attr void a_prefix##insert(a_ph_type *ph, a_type *phn); a_attr a_type *a_prefix##remove_first(a_ph_type *ph); a_attr a_type *a_prefix##remove_any(a_ph_type *ph); a_attr void a_prefix##remove(a_ph_type *ph, a_type *phn);
