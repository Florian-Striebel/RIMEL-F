...
#define DECL_GLOB_NAME(fnd,drive,dir,fname,ext,handle) struct find_t fnd; char drive[_MAX_DRIVE]; char dir[_MAX_DIR]; char fname[_MAX_FNAME]; char ext[_MAX_EXT]; int handle;
...
#define GLOB_NAME name
#define DECL_GLOB_NAME(fnd,drive,dir,fname,ext,handle) struct _finddata_t fnd; char drive[_MAX_DRIVE]; char dir[_MAX_DIR]; char fname[_MAX_FNAME]; char ext[_MAX_EXT]; intptr_t handle;
...
#define DECL_GLOB_NAME(fnd,drive,dir,fname,ext,handle) struct ffblk fnd; char drive[MAXDRIVE]; char dir[MAXDIR]; char fname[MAXFILE]; char ext[MAXEXT]; int handle;
