...
#define DECLARE_RANGE_TABLE_START(name) static struct wchar_range name##_array[] = {

#define DECLARE_RANGE_TABLE_END(name) }; struct wchar_range_table name##_table = { name##_array, sizeof(name##_array)/sizeof(*name##_array) };
