...
#define lzx_br_bits(br, n) (((uint32_t)((br)->cache_buffer >> ((br)->cache_avail - (n)))) & cache_masks[n])


#define lzx_br_bits_forced(br, n) (((uint32_t)((br)->cache_buffer << ((n) - (br)->cache_avail))) & cache_masks[n])
