...
#define _7Z_CRYPTO_MAIN_ZIP 0x06F10101
#define _7Z_CRYPTO_RAR_29 0x06F10303
#define _7Z_CRYPTO_AES_256_SHA_256 0x06F10701
...
const uint64_t max_read_size = 16 * 1024 * 1024;
...
#if !defined(HAVE_ZLIB_H) &&!(defined(HAVE_BZLIB_H) && defined(BZ_CONFIG_ERROR))
...
#define RC_INIT2 zip->bcj2_code = 0; zip->bcj2_range = 0xFFFFFFFF; { int ii; for (ii = 0; ii < 5; ii++) { RC_TEST; zip->bcj2_code = (zip->bcj2_code << 8) | RC_READ_BYTE; }}
