...
#define to_int64_time(t) ((t) < 0 ? (int64_t)(t) : (uint64_t)(t) > (uint64_t)INT64_MAX ? INT64_MAX : (int64_t)(t))
...
{
#if !defined(HAVE_LSTAT) && !(defined(HAVE_OPENAT) && defined(HAVE_FSTATAT) && defined(HAVE_UNLINKAT))
...
| UF_APPEND
#endif
#if defined(EXT2_APPEND_FL)
| EXT2_APPEND_FL
#endif
#if defined(EXT2_IMMUTABLE_FL)
| EXT2_IMMUTABLE_FL
#endif
;
...
#elif (defined(FS_IOC_GETFLAGS) && defined(FS_IOC_SETFLAGS) && defined(HAVE_WORKING_FS_IOC_GETFLAGS)) || (defined(EXT2_IOC_GETFLAGS) && defined(EXT2_IOC_SETFLAGS) && defined(HAVE_WORKING_EXT2_IOC_GETFLAGS))
...
#if !defined(ARCHIVE_ACL_SUPPORT)
int
