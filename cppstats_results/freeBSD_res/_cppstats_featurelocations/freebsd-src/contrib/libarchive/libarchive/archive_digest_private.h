...
#if !defined(ARCHIVE_DIGEST_PRIVATE_H_INCLUDED)
#define ARCHIVE_DIGEST_PRIVATE_H_INCLUDED

#if !defined(__LIBARCHIVE_BUILD)
#error This header is only to be used internally to libarchive.
#endif
#if !defined(__LIBARCHIVE_CONFIG_H_INCLUDED)
...
#include <sha1.h>
#endif
#if defined(ARCHIVE_CRYPTO_SHA256_LIBC) ||defined(ARCHIVE_CRYPTO_SHA256_LIBC2) ||defined(ARCHIVE_CRYPTO_SHA256_LIBC3) ||defined(ARCHIVE_CRYPTO_SHA384_LIBC) ||defined(ARCHIVE_CRYPTO_SHA384_LIBC2) ||defined(ARCHIVE_CRYPTO_SHA384_LIBC3) ||defined(ARCHIVE_CRYPTO_SHA512_LIBC) ||defined(ARCHIVE_CRYPTO_SHA512_LIBC2) ||defined(ARCHIVE_CRYPTO_SHA512_LIBC3)
...
#if defined(ARCHIVE_CRYPTO_MD5_LIBMD) ||defined(ARCHIVE_CRYPTO_RMD160_LIBMD) ||defined(ARCHIVE_CRYPTO_SHA1_LIBMD) ||defined(ARCHIVE_CRYPTO_SHA256_LIBMD) ||defined(ARCHIVE_CRYPTO_SHA512_LIBMD)
...
#if defined(ARCHIVE_CRYPTO_MD5_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA1_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA256_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA384_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA512_LIBSYSTEM)
...
#endif
#if defined(ARCHIVE_CRYPTO_SHA384_MBEDTLS) ||defined(ARCHIVE_CRYPTO_SHA512_MBEDTLS)
...
#endif
#if defined(ARCHIVE_CRYPTO_SHA1_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA256_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA384_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA512_NETTLE)
...
#if defined(ARCHIVE_CRYPTO_MD5_OPENSSL) ||defined(ARCHIVE_CRYPTO_RMD160_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA1_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA256_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA384_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA512_OPENSSL)
...
#if defined(ARCHIVE_CRYPTO_MD5_LIBC) ||defined(ARCHIVE_CRYPTO_MD5_LIBMD) || defined(ARCHIVE_CRYPTO_MD5_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_MD5_MBEDTLS) ||defined(ARCHIVE_CRYPTO_MD5_NETTLE) ||defined(ARCHIVE_CRYPTO_MD5_OPENSSL) ||defined(ARCHIVE_CRYPTO_MD5_WIN)
...
#if defined(ARCHIVE_CRYPTO_RMD160_LIBC) ||defined(ARCHIVE_CRYPTO_RMD160_MBEDTLS) ||defined(ARCHIVE_CRYPTO_RMD160_NETTLE) ||defined(ARCHIVE_CRYPTO_RMD160_OPENSSL)
...
#if defined(ARCHIVE_CRYPTO_SHA1_LIBC) ||defined(ARCHIVE_CRYPTO_SHA1_LIBMD) || defined(ARCHIVE_CRYPTO_SHA1_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA1_MBEDTLS) ||defined(ARCHIVE_CRYPTO_SHA1_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA1_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA1_WIN)
...
#if defined(ARCHIVE_CRYPTO_SHA384_LIBC) ||defined(ARCHIVE_CRYPTO_SHA384_LIBC2) ||defined(ARCHIVE_CRYPTO_SHA384_LIBC3) ||defined(ARCHIVE_CRYPTO_SHA384_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA384_MBEDTLS) ||defined(ARCHIVE_CRYPTO_SHA384_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA384_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA384_WIN)
...
#if defined(ARCHIVE_CRYPTO_SHA512_LIBC) ||defined(ARCHIVE_CRYPTO_SHA512_LIBC2) ||defined(ARCHIVE_CRYPTO_SHA512_LIBC3) ||defined(ARCHIVE_CRYPTO_SHA512_LIBMD) ||defined(ARCHIVE_CRYPTO_SHA512_LIBSYSTEM) ||defined(ARCHIVE_CRYPTO_SHA512_MBEDTLS) ||defined(ARCHIVE_CRYPTO_SHA512_NETTLE) ||defined(ARCHIVE_CRYPTO_SHA512_OPENSSL) ||defined(ARCHIVE_CRYPTO_SHA512_WIN)
