...
#define RPC_LEGACY(name) { #name, run_legacy_test_fn, TT_FORK|TT_NEED_BASE|TT_LEGACY, &legacy_setup, rpc_##name }
...
#define RPC_LEGACY(name) { #name, NULL, TT_SKIP, NULL, NULL }
