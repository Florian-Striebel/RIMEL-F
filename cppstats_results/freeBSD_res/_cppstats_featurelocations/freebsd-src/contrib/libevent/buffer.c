...
#if defined(EVENT__HAVE_VASPRINTF)
...
#if defined(EVENT__HAVE_SYS_MMAN_H)
#include <sys/mman.h>
#endif

#if defined(EVENT__HAVE_SYS_SENDFILE_H)
#include <sys/sendfile.h>
#endif
#if defined(EVENT__HAVE_SYS_STAT_H)
#include <sys/stat.h>
#endif
...
#define PTR_NOT_FOUND(ptr) do { (ptr)->pos = -1; (ptr)->internal_.chain = NULL; (ptr)->internal_.pos_in_chain = 0; } while (0)
...
#if defined(EVBUFFER_IOVEC_IS_NATIVE_)
