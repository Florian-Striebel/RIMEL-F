...
#if !defined(EVENT2_RPC_H_INCLUDED_)
...
#define EVRPC_MAKE_CTX(rpcname, reqstruct, rplystruct, pool, request, reply, cb, cbarg) evrpc_make_request_ctx(pool, request, reply, #rpcname, (void (*)(struct evbuffer *, void *))reqstruct##_marshal, (void (*)(void *))rplystruct##_clear, (int (*)(void *, struct evbuffer *))rplystruct##_unmarshal, (void (*)(struct evrpc_status *, void *, void *, void *))cb, cbarg)
...
#define EVRPC_REQUEST_DONE(rpc_req) do { struct evrpc_req_generic *req_ = (struct evrpc_req_generic *)(rpc_req); evrpc_request_done(req_); } while (0)
