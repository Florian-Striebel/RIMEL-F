...
#if !defined(EPOLLTABLE_INTERNAL_H_INCLUDED_)
...
#define EPOLL_OP_TABLE_INDEX(c) ( (((c)->close_change&(EV_CHANGE_ADD|EV_CHANGE_DEL))) | (((c)->read_change&(EV_CHANGE_ADD|EV_CHANGE_DEL)) << 2) | (((c)->write_change&(EV_CHANGE_ADD|EV_CHANGE_DEL)) << 4) | (((c)->old_events&(EV_READ|EV_WRITE)) << 5) | (((c)->old_events&(EV_CLOSED)) << 1) )
