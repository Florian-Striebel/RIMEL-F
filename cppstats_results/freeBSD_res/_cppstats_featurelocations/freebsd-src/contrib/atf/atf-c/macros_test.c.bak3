...
#define H_DEF(id, macro) ATF_TC_HEAD(h_ ##id, tc) { atf_tc_set_md_var(tc, "descr", "Helper test case"); } ATF_TC_BODY(h_ ##id, tc) { create_ctl_file("before"); macro; create_ctl_file("after"); }
...
#define H_CHECK(id, condition) H_DEF(check_ ##id, ATF_CHECK(condition))
...
#define H_CHECK_MSG(id, condition, msg) H_DEF(check_msg_ ##id, ATF_CHECK_MSG(condition, msg))
...
#define H_CHECK_EQ(id, v1, v2) H_DEF(check_eq_ ##id, ATF_CHECK_EQ(v1, v2))
...
#define H_CHECK_STREQ(id, v1, v2) H_DEF(check_streq_ ##id, ATF_CHECK_STREQ(v1, v2))
...
#define H_CHECK_MATCH(id, v1, v2) H_DEF(check_match_ ##id, ATF_CHECK_MATCH(v1, v2))


#define H_CHECK_EQ_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_check_eq_msg_ ##id)

#define H_CHECK_EQ_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_check_eq_msg_ ##id)

#define H_CHECK_EQ_MSG(id, v1, v2, msg) H_DEF(check_eq_msg_ ##id, ATF_CHECK_EQ_MSG(v1, v2, msg))


#define H_CHECK_STREQ_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_check_streq_msg_ ##id)

#define H_CHECK_STREQ_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_check_streq_msg_ ##id)

#define H_CHECK_STREQ_MSG(id, v1, v2, msg) H_DEF(check_streq_msg_ ##id, ATF_CHECK_STREQ_MSG(v1, v2, msg))


#define H_CHECK_MATCH_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_check_match_msg_ ##id)

#define H_CHECK_MATCH_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_check_match_msg_ ##id)

#define H_CHECK_MATCH_MSG(id, v1, v2, msg) H_DEF(check_match_msg_ ##id, ATF_CHECK_MATCH_MSG(v1, v2, msg))
...
#define H_CHECK_ERRNO(id, exp_errno, bool_expr) H_DEF(check_errno_ ##id, ATF_CHECK_ERRNO(exp_errno, bool_expr))


#define H_REQUIRE_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_require_ ##id)
#define H_REQUIRE_BODY_NAME(id) ATF_TC_BODY_NAME(h_require_ ##id)
#define H_REQUIRE(id, condition) H_DEF(require_ ##id, ATF_REQUIRE(condition))
...
#define H_REQUIRE_MSG(id, condition, msg) H_DEF(require_msg_ ##id, ATF_REQUIRE_MSG(condition, msg))
...
#define H_REQUIRE_EQ(id, v1, v2) H_DEF(require_eq_ ##id, ATF_REQUIRE_EQ(v1, v2))
...
#define H_REQUIRE_STREQ(id, v1, v2) H_DEF(require_streq_ ##id, ATF_REQUIRE_STREQ(v1, v2))
...
#define H_REQUIRE_MATCH(id, v1, v2) H_DEF(require_match_ ##id, ATF_REQUIRE_MATCH(v1, v2))


#define H_REQUIRE_EQ_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_require_eq_msg_ ##id)

#define H_REQUIRE_EQ_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_require_eq_msg_ ##id)

#define H_REQUIRE_EQ_MSG(id, v1, v2, msg) H_DEF(require_eq_msg_ ##id, ATF_REQUIRE_EQ_MSG(v1, v2, msg))


#define H_REQUIRE_STREQ_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_require_streq_msg_ ##id)

#define H_REQUIRE_STREQ_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_require_streq_msg_ ##id)

#define H_REQUIRE_STREQ_MSG(id, v1, v2, msg) H_DEF(require_streq_msg_ ##id, ATF_REQUIRE_STREQ_MSG(v1, v2, msg))


#define H_REQUIRE_MATCH_MSG_HEAD_NAME(id) ATF_TC_HEAD_NAME(h_require_match_msg_ ##id)

#define H_REQUIRE_MATCH_MSG_BODY_NAME(id) ATF_TC_BODY_NAME(h_require_match_msg_ ##id)

#define H_REQUIRE_MATCH_MSG(id, v1, v2, msg) H_DEF(require_match_msg_ ##id, ATF_REQUIRE_MATCH_MSG(v1, v2, msg))
...
#define H_REQUIRE_ERRNO(id, exp_errno, bool_expr) H_DEF(require_errno_ ##id, ATF_REQUIRE_ERRNO(exp_errno, bool_expr))
