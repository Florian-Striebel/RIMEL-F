...
#define WRAP(type, name, args, retval, param, prob) extern type __wrap_##name args; extern type __real_##name args; type __wrap_##name args { if (prng_up && uniform_random(400) < (prob)) { return (retval); } return (__real_##name param); }
