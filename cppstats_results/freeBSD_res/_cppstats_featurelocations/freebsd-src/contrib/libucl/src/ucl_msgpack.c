...
#define SWAP_LE_BE16(val) ((uint16_t) ( (uint16_t) ((uint16_t) (val) >> 8) | (uint16_t) ((uint16_t) (val) << 8)))
...
#else
#define SWAP_LE_BE32(val) ((uint32_t)( (((uint32_t)(val) & (uint32_t)0x000000ffU) << 24) | (((uint32_t)(val) & (uint32_t)0x0000ff00U) << 8) | (((uint32_t)(val) & (uint32_t)0x00ff0000U) >> 8) | (((uint32_t)(val) & (uint32_t)0xff000000U) >> 24)))





#define SWAP_LE_BE64(val) ((uint64_t)( (((uint64_t)(val) & (uint64_t)(0x00000000000000ffULL)) << 56) | (((uint64_t)(val) & (uint64_t)(0x000000000000ff00ULL)) << 40) | (((uint64_t)(val) & (uint64_t)(0x0000000000ff0000ULL)) << 24) | (((uint64_t)(val) & (uint64_t) (0x00000000ff000000ULL)) << 8) | (((uint64_t)(val) & (uint64_t)(0x000000ff00000000ULL)) >> 8) | (((uint64_t)(val) & (uint64_t)(0x0000ff0000000000ULL)) >> 24) | (((uint64_t)(val) & (uint64_t)(0x00ff000000000000ULL)) >> 40) | (((uint64_t)(val) & (uint64_t)(0xff00000000000000ULL)) >> 56)))
...
uint8_t flags;
ucl_msgpack_parse_function func;
} parsers[] = {
{
0xa0,
3,
...
#if defined(MSGPACK_DEBUG_PARSER)
stack = parser->stack;
while (stack) {
fprintf(stderr, "+");
stack = stack->next;
...
#define CONSUME_RET do { if (ret != -1) { p += ret; remain -= ret; obj_parser = NULL; assert (remain >= 0); } else { ucl_create_err (&parser->err, "cannot parse type %d of len %u", (int)obj_parser->fmt, (unsigned)len); return false; } } while(0)
...
#define GET_NEXT_STATE do { container = ucl_msgpack_get_next_container (parser); if (container == NULL) { ucl_create_err (&parser->err, "empty container"); return false; } next_state = container->obj->type == UCL_OBJECT ? read_assoc_key : read_array_value; } while(0)
