...
#define UCL_EMIT_TYPE_CONTENT(type) { .ucl_emitter_write_elt = ucl_emit_ ##type ##_elt, .ucl_emitter_start_object = ucl_emit_ ##type ##_start_obj, .ucl_emitter_start_array = ucl_emit_ ##type ##_start_array, .ucl_emitter_end_object = ucl_emit_ ##type ##_end_object, .ucl_emitter_end_array = ucl_emit_ ##type ##_end_array }
...
#define UCL_EMIT_IDENT_TOP_OBJ(ctx, obj) ((ctx)->top != (obj) || ((ctx)->id == UCL_EMIT_JSON_COMPACT || (ctx)->id == UCL_EMIT_JSON))
