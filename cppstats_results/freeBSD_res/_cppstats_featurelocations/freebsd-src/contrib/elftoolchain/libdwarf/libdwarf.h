...
#if !defined(DW_FRAME_HIGHEST_NORMAL_REGISTER)
...
#if !defined(DW_FRAME_LAST_REG_NUM)
#define DW_FRAME_LAST_REG_NUM (DW_FRAME_HIGHEST_NORMAL_REGISTER + 3)
#endif

#if !defined(DW_FRAME_REG_INITIAL_VALUE)
