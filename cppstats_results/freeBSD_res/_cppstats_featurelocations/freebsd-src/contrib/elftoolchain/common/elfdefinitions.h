...
#define _ELF_DEFINE_CAPABILITIES() _ELF_DEFINE_CA(CA_SUNW_NULL, 0, "ignored") _ELF_DEFINE_CA(CA_SUNW_HW_1, 1, "hardware capability") _ELF_DEFINE_CA(CA_SUNW_SW_1, 2, "software capability")
...
#define _ELF_DEFINE_ELFCLASS() _ELF_DEFINE_EC(ELFCLASSNONE, 0, "Unknown ELF class") _ELF_DEFINE_EC(ELFCLASS32, 1, "32 bit objects") _ELF_DEFINE_EC(ELFCLASS64, 2, "64 bit objects")
...
#define _ELF_DEFINE_ELF_DATA_ENDIANNESS() _ELF_DEFINE_ED(ELFDATANONE, 0, "Unknown data endianness") _ELF_DEFINE_ED(ELFDATA2LSB, 1, "little endian") _ELF_DEFINE_ED(ELFDATA2MSB, 2, "big endian")
...
#define _ELF_DEFINE_ELF_MAGIC() _ELF_DEFINE_EMAG(ELFMAG0, 0x7FU) _ELF_DEFINE_EMAG(ELFMAG1, 'E') _ELF_DEFINE_EMAG(ELFMAG2, 'L') _ELF_DEFINE_EMAG(ELFMAG3, 'F')
...
#define _ELF_DEFINE_ELF_TYPES() _ELF_DEFINE_ET(ET_NONE, 0, "No file type") _ELF_DEFINE_ET(ET_REL, 1, "Relocatable object") _ELF_DEFINE_ET(ET_EXEC, 2, "Executable") _ELF_DEFINE_ET(ET_DYN, 3, "Shared object") _ELF_DEFINE_ET(ET_CORE, 4, "Core file") _ELF_DEFINE_ET(ET_LOOS, 0xFE00U, "Begin OS-specific range") _ELF_DEFINE_ET(ET_HIOS, 0xFEFFU, "End OS-specific range") _ELF_DEFINE_ET(ET_LOPROC, 0xFF00U, "Begin processor-specific range") _ELF_DEFINE_ET(ET_HIPROC, 0xFFFFU, "End processor-specific range")
...
#define _ELF_DEFINE_SYMBOL_BINDING_KINDS() _ELF_DEFINE_SYB(SYMINFO_BT_SELF, 0xFFFFU, "bound to self") _ELF_DEFINE_SYB(SYMINFO_BT_PARENT, 0xFFFEU, "bound to parent") _ELF_DEFINE_SYB(SYMINFO_BT_NONE, 0xFFFDU, "no special binding")
...
#define _ELF_DEFINE_SYMBOL_VISIBILITY() _ELF_DEFINE_STV(STV_DEFAULT, 0, "as specified by symbol type") _ELF_DEFINE_STV(STV_INTERNAL, 1, "as defined by processor semantics") _ELF_DEFINE_STV(STV_HIDDEN, 2, "hidden from other components") _ELF_DEFINE_STV(STV_PROTECTED, 3, "local references are not preemptable")
...
#define _ELF_DEFINE_VERSIONING_DEPENDENCIES() _ELF_DEFINE_VERD(VER_NDX_LOCAL, 0, "local scope") _ELF_DEFINE_VERD(VER_NDX_GLOBAL, 1, "global scope")
...
#define _ELF_DEFINE_VERSIONING_FLAGS() _ELF_DEFINE_VERF(VER_FLG_BASE, 0x1, "file version") _ELF_DEFINE_VERF(VER_FLG_WEAK, 0x2, "weak version")
...
#define _ELF_DEFINE_VERSIONING_NEEDS() _ELF_DEFINE_VRN(VER_NEED_NONE, 0, "invalid version") _ELF_DEFINE_VRN(VER_NEED_CURRENT, 1, "current version")
...
#define _ELF_DEFINE_VERSIONING_NUMBERS() _ELF_DEFINE_VRNU(VER_DEF_NONE, 0, "invalid version") _ELF_DEFINE_VRNU(VER_DEF_CURRENT, 1, "current version")
...
#define _ELF_DEFINE_LL_FLAGS() _ELF_DEFINE_LL(LL_NONE, 0, "no flags") _ELF_DEFINE_LL(LL_EXACT_MATCH, 0x1, "require an exact match") _ELF_DEFINE_LL(LL_IGNORE_INT_VER, 0x2, "ignore version incompatibilities") _ELF_DEFINE_LL(LL_REQUIRE_MINOR, 0x4, "") _ELF_DEFINE_LL(LL_EXPORTS, 0x8, "") _ELF_DEFINE_LL(LL_DELAY_LOAD, 0x10, "") _ELF_DEFINE_LL(LL_DELTA, 0x20, "")
...
#define _ELF_DEFINE_ODK_PAD_MASK() _ELF_DEFINE_OPAD(OPAD_PREFIX, 0x0001) _ELF_DEFINE_OPAD(OPAD_POSTFIX, 0x0002) _ELF_DEFINE_OPAD(OPAD_SYMBOL, 0x0004)
...
#define _ELF_DEFINE_ODK_HWP_MASK() _ELF_DEFINE_HWP(OHWA0_R4KEOP_CHECKED, 0x00000001UL, "object checked for R4000 end-of-page bug") _ELF_DEFINE_HWP(OHWA0_R4KEOP_CLEAN, 0x00000002UL, "object verified clean for R4000 end-of-page bug") _ELF_DEFINE_HWP(OHWO0_FIXADE, 0x00000001UL, "object requires call to fixade")
...
#define _ELF_DEFINE_ODK_GP_MASK() _ELF_DEFINE_OGP(OGP_GROUP, 0x0000FFFFUL, "GP group number") _ELF_DEFINE_OGP(OGP_SELF, 0x00010000UL, "GP group is self-contained")
