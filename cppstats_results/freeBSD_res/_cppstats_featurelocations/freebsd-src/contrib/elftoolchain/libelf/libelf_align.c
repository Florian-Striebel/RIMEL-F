...
#if defined(__GNUC__)
#define MALIGN(N) { .a32 = __alignof__(Elf32_##N), .a64 = __alignof__(Elf64_##N) }



#define MALIGN64(V) { .a32 = 0, .a64 = __alignof__(Elf64_##V) }



#define MALIGN_WORD() { .a32 = __alignof__(int32_t), .a64 = __alignof__(int64_t) }
...
#endif
#define UNSUPPORTED() { .a32 = 0, .a64 = 0 }
