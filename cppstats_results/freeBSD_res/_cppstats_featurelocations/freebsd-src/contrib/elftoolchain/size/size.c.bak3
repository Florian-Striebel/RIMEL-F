...
#define NOTE_OFFSET_32(nhdr, namesz, offset) ((char *)nhdr + sizeof(Elf32_Nhdr) + ELF_ALIGN((int32_t)namesz, 4) + offset)



#define NOTE_OFFSET_64(nhdr, namesz, offset) ((char *)nhdr + sizeof(Elf32_Nhdr) + ELF_ALIGN((int32_t)namesz, 8) + offset)



#define PID32(nhdr, namesz, offset) (pid_t)*((int *)((uintptr_t)NOTE_OFFSET_32(nhdr, namesz, offset)));



#define PID64(nhdr, namesz, offset) (pid_t)*((int *)((uintptr_t)NOTE_OFFSET_64(nhdr, namesz, offset)));



#define NEXT_NOTE(elfhdr, descsz, namesz, offset) do { if (elfhdr->e_ident[EI_CLASS] == ELFCLASS32) { offset += ELF_ALIGN((int32_t)descsz, 4) + sizeof(Elf32_Nhdr) + ELF_ALIGN((int32_t)namesz, 4); } else { offset += ELF_ALIGN((int32_t)descsz, 8) + sizeof(Elf32_Nhdr) + ELF_ALIGN((int32_t)namesz, 8); } } while (0)
