...
static int checkmenu(int nitems, struct bsddialog_menuitem *items)
{
int i, error;
...
BSDDIALOG_CHECKLIST , nitems, items};
...
int output;
struct bsddialog_menugroup group = {
BSDDIALOG_RADIOLIST , nitems, items};
