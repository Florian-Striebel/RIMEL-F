...
#define history_def_setunique(p, uni) if (uni) (((history_t *)p)->flags) |= H_UNIQUE; else (((history_t *)p)->flags) &= ~H_UNIQUE
...
#define he_seterrev(evp, code) {evp->num = code;evp->str = he_strerror(code);}
