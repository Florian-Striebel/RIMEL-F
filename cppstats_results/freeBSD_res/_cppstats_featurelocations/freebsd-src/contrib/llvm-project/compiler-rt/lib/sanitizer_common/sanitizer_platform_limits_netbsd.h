...
#if !defined(SANITIZER_PLATFORM_LIMITS_NETBSD_H)
...
#define GET_LINK_MAP_BY_DLOPEN_HANDLE(handle) (link_map *)__sanitizer_get_link_map_by_dlopen_handle(handle)
...
#define SHA2_EXTERN(LEN) extern const unsigned SHA##LEN##_CTX_sz; extern const unsigned SHA##LEN##_return_length; extern const unsigned SHA##LEN##_block_length; extern const unsigned SHA##LEN##_digest_length
