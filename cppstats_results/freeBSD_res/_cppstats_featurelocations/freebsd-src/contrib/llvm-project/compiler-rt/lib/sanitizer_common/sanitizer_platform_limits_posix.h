...
#if !defined(SANITIZER_PLATFORM_LIMITS_POSIX_H)
...
#if SANITIZER_LINUX
#if defined(_LP64) || defined(__x86_64__) || defined(__powerpc__) || defined(__mips__)
...
#elif SANITIZER_ANDROID && SANITIZER_MIPS32
struct __sanitizer_sigaction {
unsigned sa_flags;
union {
__sanitizer_sigactionhandler_ptr sigaction;
...
#if SANITIZER_LINUX && !SANITIZER_ANDROID && (defined(__i386) || defined(__x86_64) || defined(__mips64) || defined(__powerpc64__) || defined(__aarch64__) || defined(__arm__) || defined(__s390__) || SANITIZER_RISCV64)
...
#define IOC_SIZE(nr) ((((((nr) >> 29) & 0x7) & (4U | 2U)) == 0) ? 0 : (((nr) >> 16) & 0x3fff))
...
#define CHECK_TYPE_SIZE(TYPE) COMPILER_CHECK(sizeof(__sanitizer_##TYPE) == sizeof(TYPE))
...
#define CHECK_STRUCT_SIZE_AND_OFFSET(CLASS, MEMBER) COMPILER_CHECK(sizeof(((struct __sanitizer_##CLASS *)NULL)->MEMBER) == sizeof(((struct CLASS *)NULL)->MEMBER)); COMPILER_CHECK(offsetof(struct __sanitizer_##CLASS, MEMBER) == offsetof(struct CLASS, MEMBER))
