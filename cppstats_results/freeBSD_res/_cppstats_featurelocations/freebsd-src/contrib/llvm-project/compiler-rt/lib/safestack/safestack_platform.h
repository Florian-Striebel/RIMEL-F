...
#if !defined(SAFESTACK_PLATFORM_H)
...
#define DEFINE__REAL(ret_type, func, ...) static ret_type (*real_##func)(__VA_ARGS__) = NULL; if (!real_##func) { real_##func = (ret_type(*)(__VA_ARGS__))GetRealLibcAddress(#func); } SFS_CHECK(real_##func);
