...
#if defined(COMPILER_RT_HAS_UNAME)
...
#if defined(__ANDROID__) && defined(__ANDROID_API__) && defined(__ANDROID_API_FUTURE__) && __ANDROID_API__ == __ANDROID_API_FUTURE__
...
#if defined(COMPILER_RT_HAS_FCNTL_LCK)
