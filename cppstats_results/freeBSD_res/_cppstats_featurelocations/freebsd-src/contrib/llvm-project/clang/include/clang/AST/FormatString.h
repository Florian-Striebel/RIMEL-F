...
#if !defined(LLVM_CLANG_ANALYSIS_ANALYSES_FORMATSTRING_H)
...
OptionalFlag HasThousandsGrouping;
OptionalFlag IsLeftJustified;
OptionalFlag HasPlusPrefix;
OptionalFlag HasSpacePrefix;
OptionalFlag HasAlternativeForm;
OptionalFlag HasLeadingZeroes;
OptionalFlag HasObjCTechnicalTerm;
OptionalFlag IsPrivate;
OptionalFlag IsPublic;
OptionalFlag IsSensitive;
...
public:
PrintfSpecifier()
: FormatSpecifier( true), HasThousandsGrouping("'"),
