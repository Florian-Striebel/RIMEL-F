...
#if !defined(LLVM_CLANG_AST_COMMENTVISITOR_H)
...
#define DISPATCH(NAME, CLASS) return static_cast<ImplClass *>(this)->visit##NAME( static_cast<PTR(CLASS)>(C), std::forward<ParamTys>(P)...)
