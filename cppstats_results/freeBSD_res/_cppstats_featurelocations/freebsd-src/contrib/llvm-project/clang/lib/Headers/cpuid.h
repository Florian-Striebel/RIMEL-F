...
#if __i386__
#define __cpuid(__leaf, __eax, __ebx, __ecx, __edx) __asm("cpuid" : "=a"(__eax), "=b" (__ebx), "=c"(__ecx), "=d"(__edx) : "0"(__leaf))



#define __cpuid_count(__leaf, __count, __eax, __ebx, __ecx, __edx) __asm("cpuid" : "=a"(__eax), "=b" (__ebx), "=c"(__ecx), "=d"(__edx) : "0"(__leaf), "2"(__count))
...
#define __cpuid_count(__leaf, __count, __eax, __ebx, __ecx, __edx) __asm(" xchgq %%rbx,%q1\n" " cpuid\n" " xchgq %%rbx,%q1" : "=a"(__eax), "=r" (__ebx), "=c"(__ecx), "=d"(__edx) : "0"(__leaf), "2"(__count))
