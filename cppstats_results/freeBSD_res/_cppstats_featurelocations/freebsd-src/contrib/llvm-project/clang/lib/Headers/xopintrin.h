...
#define _mm_permute2_pd(X, Y, C, I) (__m128d)__builtin_ia32_vpermil2pd((__v2df)(__m128d)(X), (__v2df)(__m128d)(Y), (__v2di)(__m128i)(C), (I))




#define _mm256_permute2_pd(X, Y, C, I) (__m256d)__builtin_ia32_vpermil2pd256((__v4df)(__m256d)(X), (__v4df)(__m256d)(Y), (__v4di)(__m256i)(C), (I))




#define _mm_permute2_ps(X, Y, C, I) (__m128)__builtin_ia32_vpermil2ps((__v4sf)(__m128)(X), (__v4sf)(__m128)(Y), (__v4si)(__m128i)(C), (I))



#define _mm256_permute2_ps(X, Y, C, I) (__m256)__builtin_ia32_vpermil2ps256((__v8sf)(__m256)(X), (__v8sf)(__m256)(Y), (__v8si)(__m256i)(C), (I))
