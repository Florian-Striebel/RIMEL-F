...
#if !defined(__CLANG_HIP_CMATH_H__)
...
#define __DEF_FUN1(__retty, __func) __DEVICE__ __CONSTEXPR__ __retty __func(float __x) { return __func##f(__x); }



#define __DEF_FUN2(__retty, __func) __DEVICE__ __CONSTEXPR__ __retty __func(float __x, float __y) { return __func##f(__x, __y); }





#define __DEF_FUN2_FI(__retty, __func) __DEVICE__ __CONSTEXPR__ __retty __func(float __x, int __y) { return __func##f(__x, __y); }
...
#define __HIP_OVERLOAD1(__retty, __fn) template <typename __T> __DEVICE__ __CONSTEXPR__ typename __hip_enable_if<__hip::is_integral<__T>::value, __retty>::type __fn(__T __x) { return ::__fn((double)__x); }
...
#if __cplusplus >= 201103L
#define __HIP_OVERLOAD2(__retty, __fn) template <typename __T1, typename __T2> __DEVICE__ __CONSTEXPR__ typename __hip_enable_if< __hip::is_arithmetic<__T1>::value && __hip::is_arithmetic<__T2>::value, typename __hip::__promote<__T1, __T2>::type>::type __fn(__T1 __x, __T2 __y) { typedef typename __hip::__promote<__T1, __T2>::type __result_type; return __fn((__result_type)__x, (__result_type)__y); }
...
#else
#define __HIP_OVERLOAD2(__retty, __fn) template <typename __T1, typename __T2> __DEVICE__ __CONSTEXPR__ typename __hip_enable_if<__hip::is_arithmetic<__T1>::value && __hip::is_arithmetic<__T2>::value, __retty>::type __fn(__T1 __x, __T2 __y) { return __fn((double)__x, (double)__y); }
