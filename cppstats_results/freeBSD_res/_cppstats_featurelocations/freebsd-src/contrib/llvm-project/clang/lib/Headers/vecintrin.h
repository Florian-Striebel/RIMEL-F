...
#define __constant_range(PARM, LOW, HIGH) __attribute__((__enable_if__ ((PARM) >= (LOW) && (PARM) <= (HIGH), "argument must be a constant integer from " #LOW " to " #HIGH)))


#define __constant_pow2_range(PARM, LOW, HIGH) __attribute__((__enable_if__ ((PARM) >= (LOW) && (PARM) <= (HIGH) && ((PARM) & ((PARM) - 1)) == 0, "argument must be a constant power of 2 from " #LOW " to " #HIGH)))
...
#define __lcbb(X, Y) ((__typeof__((__lcbb)((X), (Y)))) __builtin_s390_lcbb((X), __builtin_constant_p((Y))? ((Y) == 64 ? 0 : (Y) == 128 ? 1 : (Y) == 256 ? 2 : (Y) == 512 ? 3 : (Y) == 1024 ? 4 : (Y) == 2048 ? 5 : (Y) == 4096 ? 6 : 0) : 0))
...
#define vec_permi(X, Y, Z) ((__typeof__((vec_permi)((X), (Y), (Z)))) __builtin_s390_vpdi((__vector unsigned long long)(X), (__vector unsigned long long)(Y), (((Z) & 2) << 1) | ((Z) & 1)))
...
#define vec_load_bndry(X, Y) ((__typeof__((vec_load_bndry)((X), (Y)))) __builtin_s390_vlbb((X), ((Y) == 64 ? 0 : (Y) == 128 ? 1 : (Y) == 256 ? 2 : (Y) == 512 ? 3 : (Y) == 1024 ? 4 : (Y) == 2048 ? 5 : (Y) == 4096 ? 6 : -1)))
...
#define vec_rl_mask(X, Y, Z) ((__typeof__((vec_rl_mask)((X), (Y), (Z)))) __extension__ ({ __vector unsigned char __res; __vector unsigned char __x = (__vector unsigned char)(X); __vector unsigned char __y = (__vector unsigned char)(Y); switch (sizeof ((X)[0])) { case 1: __res = (__vector unsigned char) __builtin_s390_verimb( (__vector unsigned char)__x, (__vector unsigned char)__x, (__vector unsigned char)__y, (Z)); break; case 2: __res = (__vector unsigned char) __builtin_s390_verimh( (__vector unsigned short)__x, (__vector unsigned short)__x, (__vector unsigned short)__y, (Z)); break; case 4: __res = (__vector unsigned char) __builtin_s390_verimf( (__vector unsigned int)__x, (__vector unsigned int)__x, (__vector unsigned int)__y, (Z)); break; default: __res = (__vector unsigned char) __builtin_s390_verimg( (__vector unsigned long long)__x, (__vector unsigned long long)__x, (__vector unsigned long long)__y, (Z)); break; } __res; }))
...
#define vec_sld(X, Y, Z) ((__typeof__((vec_sld)((X), (Y), (Z)))) __builtin_s390_vsldb((__vector unsigned char)(X), (__vector unsigned char)(Y), (Z)))
...
#define vec_sldw(X, Y, Z) ((__typeof__((vec_sldw)((X), (Y), (Z)))) __builtin_s390_vsldb((__vector unsigned char)(X), (__vector unsigned char)(Y), (Z) * 4))
...
#define vec_sldb(X, Y, Z) ((__typeof__((vec_sldb)((X), (Y), (Z)))) __builtin_s390_vsld((__vector unsigned char)(X), (__vector unsigned char)(Y), (Z)))
...
#define vec_srdb(X, Y, Z) ((__typeof__((vec_srdb)((X), (Y), (Z)))) __builtin_s390_vsrd((__vector unsigned char)(X), (__vector unsigned char)(Y), (Z)))
...
#if __ARCH__ >= 12
#define vec_msum_u128(X, Y, Z, W) ((__vector unsigned char)__builtin_s390_vmslg((X), (Y), (Z), (W)));
...
#define vec_fp_test_data_class(X, Y, Z) ((__typeof__((vec_fp_test_data_class)((X), (Y), (Z)))) __extension__ ({ __vector unsigned char __res; __vector unsigned char __x = (__vector unsigned char)(X); int *__z = (Z); switch (sizeof ((X)[0])) { case 4: __res = (__vector unsigned char) __builtin_s390_vftcisb((__vector float)__x, (Y), __z); break; default: __res = (__vector unsigned char) __builtin_s390_vftcidb((__vector double)__x, (Y), __z); break; } __res; }))
...
#else
#define vec_fp_test_data_class(X, Y, Z) ((__vector __bool long long)__builtin_s390_vftcidb((X), (Y), (Z)))
...
#if __ARCH__ >= 14
#define vec_extend_to_fp32_hi(X, W) ((__vector float)__builtin_s390_vclfnhs((X), (W)));
...
#if __ARCH__ >= 14
#define vec_extend_to_fp32_lo(X, W) ((__vector float)__builtin_s390_vclfnls((X), (W)));
...
#if __ARCH__ >= 14
#define vec_round_from_fp32(X, Y, W) ((__vector unsigned short)__builtin_s390_vcrnfs((X), (Y), (W)));
...
#if __ARCH__ >= 14
#define vec_convert_to_fp16(X, W) ((__vector unsigned short)__builtin_s390_vcfn((X), (W)));
...
#if __ARCH__ >= 14
#define vec_convert_from_fp16(X, W) ((__vector unsigned short)__builtin_s390_vcnf((X), (W)));
