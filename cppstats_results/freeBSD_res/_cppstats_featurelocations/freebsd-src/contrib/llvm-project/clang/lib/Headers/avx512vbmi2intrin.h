...
#if !defined(__AVX512VBMI2INTRIN_H)
...
#define _mm512_shldi_epi64(A, B, I) (__m512i)__builtin_ia32_vpshldq512((__v8di)(__m512i)(A), (__v8di)(__m512i)(B), (int)(I))



#define _mm512_mask_shldi_epi64(S, U, A, B, I) (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), (__v8di)_mm512_shldi_epi64((A), (B), (I)), (__v8di)(__m512i)(S))




#define _mm512_maskz_shldi_epi64(U, A, B, I) (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), (__v8di)_mm512_shldi_epi64((A), (B), (I)), (__v8di)_mm512_setzero_si512())




#define _mm512_shldi_epi32(A, B, I) (__m512i)__builtin_ia32_vpshldd512((__v16si)(__m512i)(A), (__v16si)(__m512i)(B), (int)(I))



#define _mm512_mask_shldi_epi32(S, U, A, B, I) (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), (__v16si)_mm512_shldi_epi32((A), (B), (I)), (__v16si)(__m512i)(S))




#define _mm512_maskz_shldi_epi32(U, A, B, I) (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), (__v16si)_mm512_shldi_epi32((A), (B), (I)), (__v16si)_mm512_setzero_si512())




#define _mm512_shldi_epi16(A, B, I) (__m512i)__builtin_ia32_vpshldw512((__v32hi)(__m512i)(A), (__v32hi)(__m512i)(B), (int)(I))



#define _mm512_mask_shldi_epi16(S, U, A, B, I) (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), (__v32hi)_mm512_shldi_epi16((A), (B), (I)), (__v32hi)(__m512i)(S))




#define _mm512_maskz_shldi_epi16(U, A, B, I) (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), (__v32hi)_mm512_shldi_epi16((A), (B), (I)), (__v32hi)_mm512_setzero_si512())




#define _mm512_shrdi_epi64(A, B, I) (__m512i)__builtin_ia32_vpshrdq512((__v8di)(__m512i)(A), (__v8di)(__m512i)(B), (int)(I))



#define _mm512_mask_shrdi_epi64(S, U, A, B, I) (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), (__v8di)_mm512_shrdi_epi64((A), (B), (I)), (__v8di)(__m512i)(S))




#define _mm512_maskz_shrdi_epi64(U, A, B, I) (__m512i)__builtin_ia32_selectq_512((__mmask8)(U), (__v8di)_mm512_shrdi_epi64((A), (B), (I)), (__v8di)_mm512_setzero_si512())




#define _mm512_shrdi_epi32(A, B, I) (__m512i)__builtin_ia32_vpshrdd512((__v16si)(__m512i)(A), (__v16si)(__m512i)(B), (int)(I))



#define _mm512_mask_shrdi_epi32(S, U, A, B, I) (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), (__v16si)_mm512_shrdi_epi32((A), (B), (I)), (__v16si)(__m512i)(S))




#define _mm512_maskz_shrdi_epi32(U, A, B, I) (__m512i)__builtin_ia32_selectd_512((__mmask16)(U), (__v16si)_mm512_shrdi_epi32((A), (B), (I)), (__v16si)_mm512_setzero_si512())




#define _mm512_shrdi_epi16(A, B, I) (__m512i)__builtin_ia32_vpshrdw512((__v32hi)(__m512i)(A), (__v32hi)(__m512i)(B), (int)(I))



#define _mm512_mask_shrdi_epi16(S, U, A, B, I) (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), (__v32hi)_mm512_shrdi_epi16((A), (B), (I)), (__v32hi)(__m512i)(S))




#define _mm512_maskz_shrdi_epi16(U, A, B, I) (__m512i)__builtin_ia32_selectw_512((__mmask32)(U), (__v32hi)_mm512_shrdi_epi16((A), (B), (I)), (__v32hi)_mm512_setzero_si512())
