...
#if !defined(__AVX512VLDQINTRIN_H)
...
#define _mm256_extractf64x2_pd(A, imm) (__m128d)__builtin_ia32_extractf64x2_256_mask((__v4df)(__m256d)(A), (int)(imm), (__v2df)_mm_undefined_pd(), (__mmask8)-1)





#define _mm256_mask_extractf64x2_pd(W, U, A, imm) (__m128d)__builtin_ia32_extractf64x2_256_mask((__v4df)(__m256d)(A), (int)(imm), (__v2df)(__m128d)(W), (__mmask8)(U))





#define _mm256_maskz_extractf64x2_pd(U, A, imm) (__m128d)__builtin_ia32_extractf64x2_256_mask((__v4df)(__m256d)(A), (int)(imm), (__v2df)_mm_setzero_pd(), (__mmask8)(U))





#define _mm256_extracti64x2_epi64(A, imm) (__m128i)__builtin_ia32_extracti64x2_256_mask((__v4di)(__m256i)(A), (int)(imm), (__v2di)_mm_undefined_si128(), (__mmask8)-1)





#define _mm256_mask_extracti64x2_epi64(W, U, A, imm) (__m128i)__builtin_ia32_extracti64x2_256_mask((__v4di)(__m256i)(A), (int)(imm), (__v2di)(__m128i)(W), (__mmask8)(U))





#define _mm256_maskz_extracti64x2_epi64(U, A, imm) (__m128i)__builtin_ia32_extracti64x2_256_mask((__v4di)(__m256i)(A), (int)(imm), (__v2di)_mm_setzero_si128(), (__mmask8)(U))





#define _mm256_insertf64x2(A, B, imm) (__m256d)__builtin_ia32_insertf64x2_256((__v4df)(__m256d)(A), (__v2df)(__m128d)(B), (int)(imm))



#define _mm256_mask_insertf64x2(W, U, A, B, imm) (__m256d)__builtin_ia32_selectpd_256((__mmask8)(U), (__v4df)_mm256_insertf64x2((A), (B), (imm)), (__v4df)(__m256d)(W))




#define _mm256_maskz_insertf64x2(U, A, B, imm) (__m256d)__builtin_ia32_selectpd_256((__mmask8)(U), (__v4df)_mm256_insertf64x2((A), (B), (imm)), (__v4df)_mm256_setzero_pd())




#define _mm256_inserti64x2(A, B, imm) (__m256i)__builtin_ia32_inserti64x2_256((__v4di)(__m256i)(A), (__v2di)(__m128i)(B), (int)(imm))



#define _mm256_mask_inserti64x2(W, U, A, B, imm) (__m256i)__builtin_ia32_selectq_256((__mmask8)(U), (__v4di)_mm256_inserti64x2((A), (B), (imm)), (__v4di)(__m256i)(W))




#define _mm256_maskz_inserti64x2(U, A, B, imm) (__m256i)__builtin_ia32_selectq_256((__mmask8)(U), (__v4di)_mm256_inserti64x2((A), (B), (imm)), (__v4di)_mm256_setzero_si256())




#define _mm_mask_fpclass_pd_mask(U, A, imm) (__mmask8)__builtin_ia32_fpclasspd128_mask((__v2df)(__m128d)(A), (int)(imm), (__mmask8)(U))



#define _mm_fpclass_pd_mask(A, imm) (__mmask8)__builtin_ia32_fpclasspd128_mask((__v2df)(__m128d)(A), (int)(imm), (__mmask8)-1)



#define _mm256_mask_fpclass_pd_mask(U, A, imm) (__mmask8)__builtin_ia32_fpclasspd256_mask((__v4df)(__m256d)(A), (int)(imm), (__mmask8)(U))



#define _mm256_fpclass_pd_mask(A, imm) (__mmask8)__builtin_ia32_fpclasspd256_mask((__v4df)(__m256d)(A), (int)(imm), (__mmask8)-1)



#define _mm_mask_fpclass_ps_mask(U, A, imm) (__mmask8)__builtin_ia32_fpclassps128_mask((__v4sf)(__m128)(A), (int)(imm), (__mmask8)(U))



#define _mm_fpclass_ps_mask(A, imm) (__mmask8)__builtin_ia32_fpclassps128_mask((__v4sf)(__m128)(A), (int)(imm), (__mmask8)-1)



#define _mm256_mask_fpclass_ps_mask(U, A, imm) (__mmask8)__builtin_ia32_fpclassps256_mask((__v8sf)(__m256)(A), (int)(imm), (__mmask8)(U))



#define _mm256_fpclass_ps_mask(A, imm) (__mmask8)__builtin_ia32_fpclassps256_mask((__v8sf)(__m256)(A), (int)(imm), (__mmask8)-1)
