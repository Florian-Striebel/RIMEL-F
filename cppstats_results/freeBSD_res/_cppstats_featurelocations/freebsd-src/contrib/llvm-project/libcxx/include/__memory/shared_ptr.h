...
#if !defined(_LIBCPP___MEMORY_SHARED_PTR_H)
...
#if !defined(_LIBCPP_HAS_NO_THREADS) && defined(__ATOMIC_RELAXED) && (__has_builtin(__atomic_load_n) || defined(_LIBCPP_COMPILER_GCC))
...
#if !defined(_LIBCPP_HAS_NO_THREADS) && defined(__ATOMIC_ACQUIRE) && (__has_builtin(__atomic_load_n) || defined(_LIBCPP_COMPILER_GCC))
