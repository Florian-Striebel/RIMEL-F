...
#if !defined(_LIBCPP___FUNCTIONAL_FUNCTION_H)
...
: public exception
{
#if defined(_LIBCPP_ABI_BAD_FUNCTION_CALL_KEY_FUNCTION)
public:
...
#define _LIBCPP_DEPRECATED_CXX03_FUNCTION __attribute__((deprecated("Using std::function in C++03 is not supported anymore. Please upgrade to C++11 or later, or use a different type")))

#else
#define _LIBCPP_DEPRECATED_CXX03_FUNCTION
#endif

template<class _Fp> class _LIBCPP_DEPRECATED_CXX03_FUNCTION _LIBCPP_TEMPLATE_VIS function;
...
#endif
{
#if !defined(_LIBCPP_ABI_OPTIMIZED_FUNCTION)
...
#if !defined(_LIBCPP_HAS_NO_DEDUCTION_GUIDES)
