...
#if !defined(GMOCK_INCLUDE_GMOCK_GMOCK_SPEC_BUILDERS_H_)
...
#define GMOCK_ON_CALL_IMPL_(mock_expr, Setter, call) ((mock_expr).gmock_##call)(::testing::internal::GetWithoutMatchers(), NULL) .Setter(__FILE__, __LINE__, #mock_expr, #call)
