...
#define UTF8_GET_NAMING2(pages, byte) (namingBitmap[((pages)[(((byte)[0]) >> 2) & 7] << 3) + ((((byte)[0]) & 3) << 1) + ((((byte)[1]) >> 5) & 1)] & (1u << (((byte)[1]) & 0x1F)))
...
#define UTF8_GET_NAMING3(pages, byte) (namingBitmap [((pages)[((((byte)[0]) & 0xF) << 4) + ((((byte)[1]) >> 2) & 0xF)] << 3) + ((((byte)[1]) & 3) << 1) + ((((byte)[2]) >> 5) & 1)] & (1u << (((byte)[2]) & 0x1F)))
...
#define UTF8_GET_NAMING(pages, p, n) ((n) == 2 ? UTF8_GET_NAMING2(pages, (const unsigned char *)(p)) : ((n) == 3 ? UTF8_GET_NAMING3(pages, (const unsigned char *)(p)) : 0))
...
#define UTF8_INVALID3(p) (((p)[2] & 0x80) == 0 || ((*p) == 0xEF && (p)[1] == 0xBF ? (p)[2] > 0xBD : ((p)[2] & 0xC0) == 0xC0) || ((*p) == 0xE0 ? (p)[1] < 0xA0 || ((p)[1] & 0xC0) == 0xC0 : ((p)[1] & 0x80) == 0 || ((*p) == 0xED ? (p)[1] > 0x9F : ((p)[1] & 0xC0) == 0xC0)))
...
#define UTF8_INVALID4(p) (((p)[3] & 0x80) == 0 || ((p)[3] & 0xC0) == 0xC0 || ((p)[2] & 0x80) == 0 || ((p)[2] & 0xC0) == 0xC0 || ((*p) == 0xF0 ? (p)[1] < 0x90 || ((p)[1] & 0xC0) == 0xC0 : ((p)[1] & 0x80) == 0 || ((*p) == 0xF4 ? (p)[1] > 0x8F : ((p)[1] & 0xC0) == 0xC0)))
...
#define NULL_VTABLE NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL
...
#define LITTLE2_BYTE_TYPE(enc, p) ((p)[1] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)*(p)] : unicode_byte_type((p)[1], (p)[0]))
...
#define BIG2_BYTE_TYPE(enc, p) ((p)[0] == 0 ? ((struct normal_encoding *)(enc))->type[(unsigned char)(p)[1]] : unicode_byte_type((p)[0], (p)[1]))
