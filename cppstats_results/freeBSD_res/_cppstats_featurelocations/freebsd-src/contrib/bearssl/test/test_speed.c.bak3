...
#define SPEED_AES(iname) SPEED_BLOCKCIPHER_CBC(AES-128 CBC encrypt (iname), aes128_ ##iname ##_cbcenc, aes_ ##iname, 16, enc) SPEED_BLOCKCIPHER_CBC(AES-128 CBC decrypt (iname), aes128_ ##iname ##_cbcdec, aes_ ##iname, 16, dec) SPEED_BLOCKCIPHER_CBC(AES-192 CBC encrypt (iname), aes192_ ##iname ##_cbcenc, aes_ ##iname, 24, enc) SPEED_BLOCKCIPHER_CBC(AES-192 CBC decrypt (iname), aes192_ ##iname ##_cbcdec, aes_ ##iname, 24, dec) SPEED_BLOCKCIPHER_CBC(AES-256 CBC encrypt (iname), aes256_ ##iname ##_cbcenc, aes_ ##iname, 32, enc) SPEED_BLOCKCIPHER_CBC(AES-256 CBC decrypt (iname), aes256_ ##iname ##_cbcdec, aes_ ##iname, 32, dec) SPEED_BLOCKCIPHER_CTR(AES-128 CTR (iname), aes128_ ##iname ##_ctr, aes_ ##iname, 16) SPEED_BLOCKCIPHER_CTR(AES-192 CTR (iname), aes192_ ##iname ##_ctr, aes_ ##iname, 24) SPEED_BLOCKCIPHER_CTR(AES-256 CTR (iname), aes256_ ##iname ##_ctr, aes_ ##iname, 32)
...
#define SPEED_DES(iname) SPEED_BLOCKCIPHER_CBC(DES CBC encrypt (iname), des_ ##iname ##_cbcenc, des_ ##iname, 8, enc) SPEED_BLOCKCIPHER_CBC(DES CBC decrypt (iname), des_ ##iname ##_cbcdec, des_ ##iname, 8, dec) SPEED_BLOCKCIPHER_CBC(3DES CBC encrypt (iname), 3des_ ##iname ##_cbcenc, des_ ##iname, 24, enc) SPEED_BLOCKCIPHER_CBC(3DES CBC decrypt (iname), 3des_ ##iname ##_cbcdec, des_ ##iname, 24, dec)
...
#define SPEED_EAX(Algo, algo, keysize, impl) static void test_speed_eax_ ##algo ##keysize ##_ ##impl(void) { test_speed_eax_inner("EAX " #Algo "-" #keysize "(" #impl ")", br_ ##algo ##_ ##impl ##_ctrcbc_get_vtable() , (keysize) >> 3); }
