...
void
prof_backtrace(prof_bt_t *bt) {
#define BT_FRAME(i) if ((i) < PROF_BT_MAX) { void *p; if (__builtin_frame_address(i) == 0) { return; } p = __builtin_return_address(i); if (p == NULL) { return; } bt->vec[(i)] = p; bt->len = (i) + 1; } else { return; }
