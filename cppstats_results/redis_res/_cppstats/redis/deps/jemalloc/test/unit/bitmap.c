...
#define NB(nbits) { if (nbits <= BITMAP_MAXBITS) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); test_bitmap_initializer_body(&binfo, nbits); } }
NBITS_TAB
#undef NB
}
TEST_END
...
#define NB(nbits) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); prev_size = test_bitmap_size_body(&binfo, nbits, prev_size); }
prev_size = 0;
NBITS_TAB
#undef NB
}
...
#define NB(nbits) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); test_bitmap_init_body(&binfo, nbits); }
NBITS_TAB
#undef NB
}
TEST_END
...
#define NB(nbits) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); test_bitmap_set_body(&binfo, nbits); }
NBITS_TAB
#undef NB
}
TEST_END
...
#define NB(nbits) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); test_bitmap_unset_body(&binfo, nbits); }
NBITS_TAB
#undef NB
}
TEST_END
...
#define NB(nbits) { bitmap_info_t binfo = BITMAP_INFO_INITIALIZER(nbits); test_bitmap_xfu_body(&binfo, nbits); }
NBITS_TAB
#undef NB
}
TEST_END
