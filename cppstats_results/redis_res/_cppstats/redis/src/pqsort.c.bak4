...
#define swapcode(TYPE, parmi, parmj, n) { size_t i = (n) / sizeof (TYPE); TYPE *pi = (TYPE *)(void *)(parmi); TYPE *pj = (TYPE *)(void *)(parmj); do { TYPE t = *pi; *pi++ = *pj; *pj++ = t; } while (--i > 0); }
...
#define swap(a, b) if (swaptype == 0) { long t = *(long *)(void *)(a); *(long *)(void *)(a) = *(long *)(void *)(b); *(long *)(void *)(b) = t; } else swapfunc(a, b, es, swaptype)
