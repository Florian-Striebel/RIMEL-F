...
#define _REDISMODULE_EVENT_NEXT 16
...
char *replid1;
char *replid2;
uint64_t repl1_offset;
uint64_t repl2_offset;
...
#if !defined(REDISMODULE_ATTR_UNUSED)
#if defined(__GNUC__)
...
#if !defined(REDISMODULE_ATTR_PRINTF)
#if defined(__GNUC__)
...
#if !defined(REDISMODULE_ATTR_COMMON)
...
#if !defined(REDISMODULE_API)
#define REDISMODULE_API
#endif


#if !defined(REDISMODULE_ATTR)
