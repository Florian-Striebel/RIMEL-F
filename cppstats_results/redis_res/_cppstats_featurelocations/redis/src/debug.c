...
#define NOT_SUPPORTED() do {UNUSED(uc);return NULL;} while(0)
...
#define NOT_SUPPORTED() do {UNUSED(uc);serverLog(LL_WARNING," Dumping of registers not supported for this OS/arch");} while(0)
