#if !defined(JEMALLOC_INTERNAL_MACROS_H)
...
#if (defined(__GNUC__) || defined(__GNUG__)) && !defined(__clang__) && defined(JEMALLOC_HAVE_ATTR) && (__GNUC__ >= 7)
...
#define JEMALLOC_DIAGNOSTIC_IGNORE_MISSING_STRUCT_FIELD_INITIALIZERS JEMALLOC_DIAGNOSTIC_IGNORE("-Wmissing-field-initializers")

#else
#define JEMALLOC_DIAGNOSTIC_IGNORE_MISSING_STRUCT_FIELD_INITIALIZERS
#endif

#define JEMALLOC_DIAGNOSTIC_IGNORE_TYPE_LIMITS JEMALLOC_DIAGNOSTIC_IGNORE("-Wtype-limits")

#define JEMALLOC_DIAGNOSTIC_IGNORE_UNUSED_PARAMETER JEMALLOC_DIAGNOSTIC_IGNORE("-Wunused-parameter")
...
#define JEMALLOC_DIAGNOSTIC_IGNORE_ALLOC_SIZE_LARGER_THAN
#endif
#define JEMALLOC_DIAGNOSTIC_DISABLE_SPURIOUS JEMALLOC_DIAGNOSTIC_PUSH JEMALLOC_DIAGNOSTIC_IGNORE_UNUSED_PARAMETER
