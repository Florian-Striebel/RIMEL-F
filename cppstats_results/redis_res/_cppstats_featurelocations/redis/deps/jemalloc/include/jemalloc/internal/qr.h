#if !defined(JEMALLOC_INTERNAL_QR_H)
...
#define qr_meld(a_qr_a, a_qr_b, a_type, a_field) do { a_type *t; (a_qr_a)->a_field.qre_prev->a_field.qre_next = (a_qr_b); (a_qr_b)->a_field.qre_prev->a_field.qre_next = (a_qr_a); t = (a_qr_a)->a_field.qre_prev; (a_qr_a)->a_field.qre_prev = (a_qr_b)->a_field.qre_prev; (a_qr_b)->a_field.qre_prev = t; } while (0)
...
#define qr_split(a_qr_a, a_qr_b, a_type, a_field) qr_meld((a_qr_a), (a_qr_b), a_type, a_field)
