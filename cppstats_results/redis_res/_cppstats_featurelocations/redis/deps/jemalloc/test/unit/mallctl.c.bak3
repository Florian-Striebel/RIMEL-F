...
#define TEST_MALLCTL_CONFIG(config, t) do { t oldval; size_t sz = sizeof(oldval); assert_d_eq(mallctl("config."#config, (void *)&oldval, &sz, NULL, 0), 0, "Unexpected mallctl() failure"); assert_b_eq(oldval, config_##config, "Incorrect config value"); assert_zu_eq(sz, sizeof(oldval), "Unexpected output size"); } while (0)
...
#define TEST_MALLCTL_OPT(t, opt, config) do { t oldval; size_t sz = sizeof(oldval); int expected = config_##config ? 0 : ENOENT; int result = mallctl("opt."#opt, (void *)&oldval, &sz, NULL, 0); assert_d_eq(result, expected, "Unexpected mallctl() result for opt."#opt); assert_zu_eq(sz, sizeof(oldval), "Unexpected output size"); } while (0)
...
#define TEST_ARENAS_CONSTANT(t, name, expected) do { t name; size_t sz = sizeof(t); assert_d_eq(mallctl("arenas."#name, (void *)&name, &sz, NULL, 0), 0, "Unexpected mallctl() failure"); assert_zu_eq(name, expected, "Incorrect "#name" size"); } while (0)
...
#define TEST_ARENAS_BIN_CONSTANT(t, name, expected) do { t name; size_t sz = sizeof(t); assert_d_eq(mallctl("arenas.bin.0."#name, (void *)&name, &sz, NULL, 0), 0, "Unexpected mallctl() failure"); assert_zu_eq(name, expected, "Incorrect "#name" size"); } while (0)
...
#define TEST_ARENAS_LEXTENT_CONSTANT(t, name, expected) do { t name; size_t sz = sizeof(t); assert_d_eq(mallctl("arenas.lextent.0."#name, (void *)&name, &sz, NULL, 0), 0, "Unexpected mallctl() failure"); assert_zu_eq(name, expected, "Incorrect "#name" size"); } while (0)
...
#define TEST_STATS_ARENAS(t, name) do { t name; size_t sz = sizeof(t); assert_d_eq(mallctl("stats.arenas.0."#name, (void *)&name, &sz, NULL, 0), 0, "Unexpected mallctl() failure"); } while (0)
