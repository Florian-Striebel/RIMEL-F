...
#define ALTI_SL2_PERM (vector unsigned char)(25,25,25,25,3,25,25,25,7,0,1,2,11,4,5,6)

#define ALTI_SL2_PERM64 (vector unsigned char)(7,25,25,25,25,25,25,25,15,0,1,2,3,4,5,6)
